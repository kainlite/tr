...
---lang---
%{
  title: "Creando una funcion lambda function con terraform",
  author: "Gabriel Garrido",
...
Antes de comenzar, asegurate de tener tu cuenta configurada para [awscli](https://docs.aws.amazon.com/cli/latest/userguide/cli-chap-configure.html) y que ya tenés instalado [terraform](https://learn.hashicorp.com/terraform/getting-started/install.html).
<br />
...
Aunque terraform puede ser útil, creo que seguiré usando el [serverless framework](https://serverless.com/) por ahora. Sin embargo, es bueno saber que hay alternativas y que, con algo de esfuerzo, pueden ofrecernos la misma funcionalidad.
<br />
