...
---lang---
%{
  title: "Usando Vault en Kubernetes",
  author: "Gabriel Garrido",
...
In this article, we will create an example using mutual TLS and provision secrets to our app. The files used in this example are available in [this repo](https://github.com/kainlite/vault-kubernetes).
<br />
...
##### **Closing notes**
This article was heavily inspired by [this guide](https://learn.hashicorp.com/vault/identity-access-management/vault-agent-k8s). We added mutual TLS for enhanced security. In a future article, we will explore auto-unsealing Vault.
