...
We will be working with the chat bot again you can see the original [article here](/blog/go_echobot), and the repo [here](https://github.com/kainlite/echobot/tree/skaffold).
