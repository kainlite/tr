defmodule Tr.Accounts.User do
  ...
  defp validate_accept_emails(changeset, _opts) do
    changeset
    |> validate_required([:accept_emails])
    |> validate_inclusion(:accept_emails, [true, false])
  end
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Tr.Repo)
  ...
  """
  def valid_password?(%Tr.Accounts.User{hashed_password: hashed_password}, password)
  ...
  @doc """
  A user changeset for changing the accept_emails field.

  """
  def accept_emails_changeset(user, attrs, opts \\ []) do
    user
    |> cast(attrs, [:accept_emails])
