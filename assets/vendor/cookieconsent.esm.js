...
const m = new p(),
  ...
  R = (e, t, o, n) => {
    e.addEventListener(t, o), n && m.o.m.push({ pe: e, me: t, ge: o });
  },
  B = () => {
...
const K = (e) => {
    ...
    ((e) => {
      ...
      R(
        ...
        (t) => {
          ...
          0 !== s.length &&
            (t.shiftKey
              ? (a !== s[0] && e.contains(a)) || (M(t), $(s[1]))
              : (a !== s[1] && e.contains(a)) || (M(t), $(s[0])));
        },
        !0,
      );
    })(e);
  ...
  ee = (e, t, o) => {
    const { de: n, le: a, ie: s, _e: c, ue: r, fe: i } = m.ce,
      l = m.re;
    if (t) {
      const n = { modalName: t };
      return (
  ...
  oe = (e) => {
    const { Y: t, ee: o, O: n, X: a, oe: c, p: r, L: i } = m.o;
    for (const e of n) {
      const n = o[e] || t[e] || [];
      for (const o of n) {
        const n = a[e][o];
  ...
  pe = (e) => {
    ...
    0 === e && me(m.ne.he, _e, o, "cm--", "box", "cm"),
      1 === e && me(m.ne.we, ue, n, le, "box", "pm");
  },
  me = (e, t, o, n, a, s) => {
    e.className = s;
    const c = o && o.layout,
  ...
  ge = (e, t) => {
    ...
    if (n.Fe) (n.Pe = k(c)), L(n.Pe, "body");
      ...
      V(e, "pm-overlay"),
        ...
        (n.Be = k(r)),
        L(n.Be, "close-btn"),
        E(n.Be, "aria-label", g.closeIconLabel || ""),
        R(n.Be, d, s),
        (n.Ge = k("span")),
        (n.Ge.innerHTML = W()),
        H(n.Be, n.Ge),
...
const ve = () => {
  ...
  xe = () => {
    ...
    e &&
      t &&
      (v(e) || (e = [e]), b(e, m.o.l) ? V(t, "cc--rtl") : j(t, "cc--rtl"));
  },
  Me = () => {
    const e = m.ne;
    if (e.Ce) return;
  ...
  Ve = (o, n = []) => {
    ((e, t) => {
      const { O: o, R: n, B: a, N: s, Z: c, G: r, X: i } = m.o;
      let l = [];
      if (e) {
      ...
      (() => {
        ...
        let n = o.L.length > 0,
          a = !1;
        for (const e of o.O)
          (o.ee[e] = G(o.Y[e], o.te[e])), o.ee[e].length > 0 && (a = !0);
        const s = m.ne.ae;
        ...
        (o.D || r) &&
          ...
          oe()),
          (c && (ee(m.re.ie), ee(m.re.le), m.t.mode === e)) ||
            (r && ee(m.re.de), o.j && ((o.j = !1), location.reload()));
      })();
  },
  Ie = (e) => {
    const t = m.o.D ? [] : m.o.R;
...
const Ue = async (e, t) => {
    ...
    return !(
      (e === Ce() && !0 !== t) ||
      !(await Se(e)) ||
      (we(e), o.T && ye(Je, Me), o.N && ge(Je, Me), xe(), 0)
    );
  },
  $e = () => {
    const { F: e, Y: t } = m.o,
      { accepted: o, rejected: n } = (() => {
        const { D: e, R: t, O: o } = m.o;
  ...
  We = () => !m.o.D,
  Xe = async (e) => {
    const { o: o, t: n, re: a } = m,
      c = window;
    if (!c._ccRun) {
      if (
        ((c._ccRun = !0),
        ((e) => {
          const { ne: o, t: n, o: a } = m,
            c = n,
            r = a,
            { cookie: i } = c,
            l = m.ce,
      ...
      if (
        (U(null, (r = Je), ge, Me),
        m.o.D && ye(r, Me),
        m.t.lazyHtmlGeneration || ge(r, Me),
        n.autoShow && !i && Oe(!0),
        i)
      )
        return oe(), ee(a.le);
  ...
  Ye = (e) => {
    const { Ce: t, ye: s } = m.ne,
      { name: c, path: r, domain: i, useLocalStorage: l } = m.t.cookie;
    e && (l ? De(c) : Pe(c, r, i));
    for (const { pe: e, me: t, ge: o } of m.o.m) e.removeEventListener(t, o);
